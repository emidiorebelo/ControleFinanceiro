        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MesNome = table.Column<string>(maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TipoId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TipoNome = table.Column<string>(maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Banner = table.Column<string>(maxLength: 15, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cartoes", x => x.CardId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ganhos_Categorias_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Despesas", x => x.ExpenseId);
                    table.ForeignKey(
                        name: "FK_Despesas_Categorias_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categorias",
                        principalColumn: "CategoryId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Despesas_Cartoes_ExpenseId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "a5ea55c8-f712-481c-bbb5-62d70eca020e", "e74d44b0-6021-46da-9847-995677680412", "Administrador do Sistema.", "Administrador", "ADMINISTRADOR" },
                    { "b7f8a4dd-19b3-4ee2-921a-89165f3ad22b", "cb44c066-0429-46e8-99de-b4fba70b9866", "Usuario do sistema.", "Usuario", "USUARIO" }
                });

            migrationBuilder.InsertData(
                table: "Meses",
                columns: new[] { "MesId", "MesNome" },
                values: new object[,]
                {
                    { 1, "Janeiro" },
                    { 2, "Fevereiro" },
